...
export default function RentDetails() {
  ...
  const handleSave = (e) => {
    ...
    navigate('/payment', {
      state: {
        car: state.car, client, startDate: state.startDate, endDate: state.endDate,
      },
    });
  };
      ...
      <div className={styles.details_card}>
        ...
        <div className={styles.card_left}>
          <div className={styles.reservation_details_row}>
            ...
            <span className={styles.reservation_value}>{state.startDate}</span>
          </div>
          <div className={styles.reservation_details_row}>
            <span className={styles.reservation_label}>End date: </span>
            <span className={styles.reservation_value}>{state.endDate}</span>
          </div>
          <div className={styles.reservation_details_row}>
            <span className={styles.reservation_label}>Duration: </span>
          ...
          <div className={styles.reservation_details_row}>
            <span className={styles.reservation_label}>Car: </span>
            <span className={styles.reservation_value}>
              {state.car.model.manufacturer}
              {' '}
              {state.car.model.model}
            </span>
          </div>
          <div className={styles.reservation_details_row}>
            <span className={styles.reservation_label}>Price: </span>
            <span className={styles.reservation_value}>
              {state.car.costPerDay * days.current}
              {' '}
              $
            </span>
          </div>

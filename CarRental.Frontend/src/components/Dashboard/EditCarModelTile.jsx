    ...
    if (!editMode) {
        return (
            <div className={styles.dashboard_card}>
                ...
                <div className={styles.dashboard_row_text}>
                    <h2 className={styles.edit_row}>Type: <span className={styles.value}>{Type}</span></h2>
                </div>
                <div className={styles.dashboard_row_text}>
                    <h2 className={styles.edit_row}>Fuel: <span className={styles.value}>{Fuel}</span></h2>
                </div>
                <div className={styles.dashboard_row_text}>
                    <h2 className={styles.edit_row}>Seats: <span className={styles.value}>{Seats}</span></h2>
                </div>
                <div className={styles.dashboard_row_text}>
                    <h2 className={styles.edit_row}>Axes: <span className={styles.value}>{Axes}</span></h2>
                </div>
                <div className={styles.dashboard_row_text}>
                    <h2 className={styles.edit_row}>HPs: <span className={styles.value}>{HPs}</span></h2>
                </div>
                <div className={styles.dashboard_row_text}>
                    <h2 className={styles.edit_row}>Gearbox: <span className={styles.value}>{Gearbox}</span></h2>
                </div>
                <div className={styles.dashboard_row_text}>
                    <h2 className={styles.edit_row}>AC: <span className={styles.value}>{AC ? "Yes" : "No"}</span></h2>
                </div>
                <div className={styles.dashboard_row_text}>
                    <h2 className={styles.edit_row}>Notes: <span className={styles.value}></span></h2>
                </div>
        ...
        return (
            <>
                <div className={styles.dashboard_card}>
                    <div className={styles.dashboard_title}>
                        <h1>Edit data about {Manufacturer} {Model}</h1>
                    </div>
